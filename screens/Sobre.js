...
export default function Sobre(props) {
    ...
    const openBrownser = async()=>{
        let result = await WebBrowser.openBrowserAsync('https://www.instagram.com/bedvibestextil');
    }
        ...
        <View style={{flex:1}} >
            <ScrollView >
                <View style={{...theme.container, paddingHorizontal:30}}>
                    ...
                    <Image style={{width:widthWindow-70, height:heightWindow-70, alignSelf:'center',
                        borderWidth:5, borderColor:'white',marginVertical:10}}
                    ...
                    <View>
                        <TouchableOpacity onPress={()=>openBrownser()} style={theme.button} >
